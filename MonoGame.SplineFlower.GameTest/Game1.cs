...
namespace MonoGame.SplineFlower.GameTest
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // MySpline = Content.Load<SplineBase>(@"CatMulRomImportTestNEW");
            // MySpline = Content.Load<SplineBase>(@"CatMulRomTest");
            // MySpline = Content.Load<SplineBase>(@"HermiteTest");
            // MySpline = Content.Load<SplineBase>(@"RaceTrack");
            // MySpline = Content.Load<SplineBase>(@"SplineFlower"); // <- CONTAINS AUDIO
             MySpline = Content.Load<SplineBase>(@"SplineTrack");
            ...
            // Center Spline
            MySpline.Position(new Vector2(GraphicsDevice.Viewport.Width / 2, GraphicsDevice.Viewport.Height / 2));
